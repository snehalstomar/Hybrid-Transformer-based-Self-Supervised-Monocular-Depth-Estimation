...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self,
        ...
        #### For dimension matching with decoder
        self.conv_for_quarter = nn.Conv2d(18, 384, kernel_size = 3, stride = 4, padding = 1, bias = True)
        self.conv_1x1 = nn.Conv2d(36, 192, kernel_size = 3, stride = 1, padding = 1, bias = True)
        self.conv_for_4_times = nn.ConvTranspose2d(72, 96, kernel_size = 6, stride = 4, padding = 1, output_padding = 0, groups=1, bias=True, dilation=1, padding_mode='zeros')
        self.conv_for_2_times_1 = nn.ConvTranspose2d(144, 48, kernel_size = 4, stride = 2, padding = 1, output_padding = 0, groups=1, bias=True, dilation=1, padding_mode='zeros')
        self.conv_for_2_times_2 = nn.ConvTranspose2d(48, 48, kernel_size = 4, stride = 2, padding = 1, output_padding = 0, groups=1, bias=True, dilation=1, padding_mode='zeros')
        self.conv_for_2_times_3 = nn.ConvTranspose2d(48, 48, kernel_size = 4, stride = 2, padding = 1, output_padding = 0, groups=1, bias=True, dilation=1, padding_mode='zeros')
        self.conv_for_2_times_4 = nn.ConvTranspose2d(48, 48, kernel_size = 4, stride = 2, padding = 1, output_padding = 0, groups=1, bias=True, dilation=1, padding_mode='zeros')
        self.conv_for_16_times = nn.Sequential(self.conv_for_2_times_1, self.conv_for_2_times_2, self.conv_for_2_times_3, self.conv_for_2_times_4) 
    ...
    def forward(self, x):
        ...
        # print('encoder_x_0.shape->', x[0].shape)
        # print('encoder_x_1.shape->', x[1].shape)
        # print('encoder_x_2.shape->', x[2].shape)
        # print('encoder_x_3.shape->', x[3].shape)
        x_0_resized = self.conv_for_quarter(x[0])
        # print('resized_encoder_x_0.shape->', x_0_resized.shape)
        x_1_resized = self.conv_1x1(x[1])
        # print('resized_encoder_x_1.shape->', x_1_resized.shape)
        x_2_resized = self.conv_for_4_times(x[2])
        # print('resized_encoder_x_2.shape->', x_2_resized.shape)
        x_3_resized = self.conv_for_16_times(x[3])
        # print('resized_encoder_x_3.shape->', x_3_resized.shape)
        # return features + mixed_features
        return [x_0_resized, x_1_resized, x_2_resized, x_3_resized]
